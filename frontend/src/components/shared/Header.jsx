...
export function Header() {
    return (
        <header className="px-8 py-4 fixed top-0 left-0 right-0 bg-[linear-gradient(180deg,rgba(63,_63,_70,_1)_64%,rgba(63,_63,_70,_0.39)_89%,rgba(63,_63,_70,_0)_100%)] h-24 z-50">
